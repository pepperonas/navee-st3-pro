...
public final class ActivityFeedbackDetailBinding implements ViewBinding {
    ...
    private ActivityFeedbackDetailBinding(@NonNull ConstraintLayout constraintLayout, @NonNull QMUIGroupListView qMUIGroupListView, @NonNull ToolbarBinding toolbarBinding) {
    ...
    public static ActivityFeedbackDetailBinding bind(@NonNull View view) {
        ...
        return new ActivityFeedbackDetailBinding((ConstraintLayout) view, qMUIGroupListView, ToolbarBinding.bind(viewFindChildViewById));
    }
    ...
    public static ActivityFeedbackDetailBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z6) {
        View viewInflate = layoutInflater.inflate(R$layout.activity_feedback_detail, viewGroup, false);
        if (z6) {
